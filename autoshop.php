            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Autoshop</li>
                    </ol>
                </div>
                <h4 class="page-title">Autoshop</h4>
            </div>
        </div>
    </div>
<div class="row">
...
<a  target="_blank"><img class="card-img-top" width="400" src="/assets/images/pub1.gif"></a>
</div>
</div>

<div class="col-md-6 col-xl-3">
<div class="card d-block">
<a  target="_blank"><img class="card-img-top" width="400" src="/assets/images/pub2.gif"></a>
</div>
</div>

<div class="col-md-6 col-xl-3">
<div class="card d-block">
<a  target="_blank"><img class="card-img-top" width="400" src="/assets/images/pub5.gif"></a>
</div>
</div>

<div class="col-md-6 col-xl-3">
<div class="card d-block">
<a  target="_blank"><img class="card-img-top" width="400" src="/assets/images/pub4.gif"></a>
</div>
</div>
</div>
</div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span>329069</span> <i class="mdi mdi-arrow-up text-success"></i></h3>
...
<div class="ribbon ribbon-primary float-right"><i class="fa fa-user-o"></i> Coucou toi !</div>
